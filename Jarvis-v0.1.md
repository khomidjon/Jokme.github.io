    ...
    <script>
        ...
        function onResults(results) {
            ...
            if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
                ...
                if (isPointing) {
                    modeText.textContent = 'DRAWING MODE ACTIVE';
                    ...
                    showNotification('Sir, object rendered successfully');
                    createHolographicObject();
                    skeletonColor = '#00FF00';
                    dotColor = '#00FF00';
                } else if (isPinching) {
                    if (isEraser) {
                        modeText.textContent = 'ERASER MODE - DELETE OBJECT';
                        ...
                        modeText.textContent = 'MANIPULATION MODE';
                        skeletonColor = '#00FF00';
                        dotColor = '#00FF00';
                        dotSize = '18px';
                        ...
                        if (!grabbedObject) {
                            for (var n = 0; n < objects3D.length; n++) {
                                if (pos.distanceTo(objects3D[n].position) < 4) {
                                    ...
                                    showNotification('Object locked');
                                    break;
                                }
                            }
                        } else {
                    ...
                    modeText.textContent = 'STANDBY MODE';
                    dotColor = '#ffffff';
                    grabbedObject = null;
                }
                ...
                modeText.textContent = 'AWAITING HAND INPUT';
        ...
        setTimeout(function() {
            cam.start().then(function() {
                modeText.textContent = 'SYSTEM ONLINE';
                showNotification('Welcome, Sir. All systems operational.');
            });
        }, 6000);
